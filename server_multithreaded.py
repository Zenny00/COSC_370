...
def process_request(connected_socket):
...
if __name__ == "__main__":
    ...
    HOSTNAME = "localhost"
    PORT_NUMBER = 5005 # This port number is not commonly used by traditional programs
    ...
    while True:
        ...
        # Create a new thread using the process_request function
        current_thread = threading.Thread(target=process_request(connected_socket))
